        ...
        <div className="relative z-10 w-full h-full flex flex-col items-center">
          ...
          <div className="w-full flex flex-col items-center pt-8 px-6 text-center max-w-4xl z-10">
            ...
            <motion.h1 
              ...
              className="text-3xl sm:text-5xl md:text-6xl lg:text-[80px] font-limelight text-[#D4AF37] mb-2 tracking-tight leading-[1.1] md:leading-[1.05]"
              id="hero-title"
            >
            ...
            <motion.p 
              ...
              className="text-xs sm:text-base md:text-lg text-[#5E6470] opacity-90 leading-relaxed max-w-xl font-normal px-4"
              id="hero-description"
            >

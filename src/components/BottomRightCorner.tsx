...
export default function BottomRightCorner({ onBookClick }: BottomRightCornerProps) {
  return (
    <motion.div 
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-[16px] md:text-[20px] font-normal text-[rgba(30,50,90,0.95)]">Our Excellence</span>
        <div className="flex items-center gap-1 text-[rgba(30,50,90,0.6)] cursor-pointer hover:text-[rgba(30,50,90,0.8)] transition-colors">
          <span className="text-[12px] md:text-[15px] font-normal">Technology</span>
